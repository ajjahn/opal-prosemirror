...
module ProseMirror
  class Node
    ...
    alias_native :type, :type, as: NodeType
    alias_native :attributes, :attrs, as: Hash
    alias_native :content, :content, as: Fragment
    alias_native :marks, :marks, as: Mark
    alias_native :node_size, :nodeSize
    alias_native :same_markup?, :sameMarkup
    alias_native :has_markup?, :hasMarkup
    alias_native :copy, :copy, as: Node
    alias_native :mark, :mark, as: Node
    alias_native :cut, :cut, as: Node
    alias_native :slice, :slice, as: Slice
    alias_native :replace, :replace, as: Node
